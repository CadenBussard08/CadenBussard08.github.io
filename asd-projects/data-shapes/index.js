$(document).ready(function () {
  ...
  //1) currentShape is an object. Use a property of the object for comparing with strings.
  //2) goodBehavior is a property, not a function. Even if it was a function, you don't assign data
  //to functions with arguments. You need to assign "bounce," etc to the goodBehaviorproperty of
  //currentShape
